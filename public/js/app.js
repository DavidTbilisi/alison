...
(function ($) {
    ...
    var octopus = function (v) {
        ...
        function checkCartCount(e) {
            axios.post(route('cartcount', true)).then(function (response) {
        ...
        $(document).on('click', v.shopIt, function (e) {
            var id = $(this).data('id');
            axios.post(route('add'), { id: id }).then(function (response) {
